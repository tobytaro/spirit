...
// UnityEngine.ScriptableObject[]
struct ScriptableObjectU5BU5D_t1204906348  : public Il2CppArray
{
public:
	ALIGN_TYPE (8) ScriptableObject_t184905905 * m_Items[1];

public:
	inline ScriptableObject_t184905905 * GetAt(il2cpp_array_size_t index) const { return m_Items[index]; }
	inline ScriptableObject_t184905905 ** GetAddressAt(il2cpp_array_size_t index) { return m_Items + index; }
	inline void SetAt(il2cpp_array_size_t index, ScriptableObject_t184905905 * value)
	{
		m_Items[index] = value;
		Il2CppCodeGenWriteBarrier(m_Items + index, value);
	}
